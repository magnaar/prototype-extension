...
test("Can't see extensions added from node_modules", t => {
    t.is(testmodule.isImported, true)
    t.is({}._.__extensions__().TestModule, void 0)
})

test("Can call a node_modules method that uses prototype-extension", t => {
    t.is(testmodule.method(), "TestModule.testMethod")
})

test("Can call a node_modules lambda that uses prototype-extension", t => {
    t.is(testmodule.lambda(), "TestModule.testForLambda")
})

test("Can call a node_modules lambda that uses prototype-extension and calls another lambda added to an extension", t => {
    t.is(testmodule.fullLambda(), "TestModule.lambda")
})

test("Can add same name extension as a node_module", t => {
    class TestModule
    {
...
test("Can't load custom accessor from node_module", t => {
